    ...
    internal static class TankNationalFamilyDetails
    {
            ...
            string id)
        {
            return
                ...
                TankT90SMFamilyDetails.Supports(id) ||
                TankT90MSFamilyDetails.Supports(id) ||
                TankT90MFamilyDetails.Supports(id) ||
            ...
            float length)
        {
            ...
            TankT72B3MFamilyDetails.Build(
                ...
                height,
                length);
            TankT80ExtendedFamilyDetails.Build(
                root,
                turret,
                definition,
                color);
