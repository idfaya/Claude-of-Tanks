...
namespace ClaudeOfTanks.Runtime
{
    internal static class TankSovietFamilyDetails
    {
            ...
            float length)
        {
            ...
            if (TankT80ExtendedFamilyDetails.Supports(id)) return;
            if (TankPolishFamilyDetails.Supports(id)) return;
            ...
            {
                TankT90ABurlakFamilyDetails.BuildHull(
                    root,
                    color);
            ...
            {
                TankT90SMFamilyDetails.BuildHull(
                    root,
                    color);
                TankT90SMTurretDetails.Build(
                    turret,
                    color);
            ...
            {
                TankT90MSFamilyDetails.BuildHull(
                    root,
                    color);
